      ...
      <div className='relative bg-[#181825] rounded-xl p-4 ring-1 ring-gray-800/50'>
            <div className='flex item-center justify-between mb-3'>
                <div className='flex item-center gap-2'>
                    <div className='flex item-center justify-center w-6 h-6 rounded-lg bg-[#1e1e2e] ring-1 ring-gray-800/50'>
                ...
                {hasContent && (
                    <button
                        onClick={handleCopy}
                        className='flex items-center gap-1.5 px-2.5 py-1.5 text-xs text-gray-400 hover:text-gray-300 bg-[#1e1e2e] rounded-lg ring-1 ring-gray-800/50 transition-all'
                    >
                        {isCopied ? (
                            <>
                    ...
                    {isRunning ? (
                        ...
                        <div className='flex items-start gap-3 text-red-400'>
                            ...
                            <div className='spce-y-1'>
                                ...
                                <div className='whitespace-pre-wrap text-red-400/80'>{error}</div>
                            </div>
                        </div>
                    ) : output ? (
